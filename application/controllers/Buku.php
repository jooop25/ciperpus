...
class Buku extends MY_Controller {
        ...
        if(isset($_POST['save'])) {
            ...
            if($this->form_validation->run()==true){
                ...
                if($cek->num_rows() > 0){
                    ...
                    $config['max_width']     = '4000'; // 4000px
                    $config['max_height']    = '4000'; // 4000px
    ...
    public function _set_rules()
    {
        ...
        $this->form_validation->set_rules('pengarang','Pengarang','required|max_length[500]');
        $this->form_validation->set_rules('penerbit','Penerbit','required|max_length[1000]');
        $this->form_validation->set_rules('klasifikasi','Klasifikasi','required|max_length[1000]'); 
