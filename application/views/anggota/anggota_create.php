        ...
        <div class="panel panel-default">
            ...
            <?php echo form_open_multipart('anggota/insert', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nis" class="form-control" placeholder="Sektor" value="<?php echo set_value('nis'); ?>" maxlength="10">
                        </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="kelas" class="form-control" placeholder="Alamat"  value="<?php echo set_value('kelas'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="username" class="form-control" placeholder="Username" value="<?php echo set_value('username'); ?>" minlength="3" maxlength="20" oninput="this.value = this.value.replace(/[^a-zA-Z0-9_]/g, '')">
                        </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="password" class="form-control" placeholder="Password" value="<?php echo set_value('password'); ?>" minlength="3">
                        </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="akses" class="form-control" >
                        ...
                        <option value="1" <?php echo set_select('akses',1); ?>>Admin</option>
                        <option value="2" <?php echo set_select('akses',2); ?>>Anggota</option>
                    </select>   
                    </div>
                </div>
