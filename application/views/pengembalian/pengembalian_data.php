        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-lg-4 ">Sektor</label>
                            <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="nominal" id="nominal" placeholder="Rp. " class="form-control">
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body"><br />
            ...
            <input type="text" name="carinis" id="carinis" class="form-control" placeholder="Mencari nomor sektor">
...
<?php }if($this->session->userdata('akses')=='Anggota'){ 
    $this->load->view('dashboard/dashboard_warning'); };?>