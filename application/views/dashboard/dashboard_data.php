...
<div class="panel panel-default">
                ...
                <div class="panel panel-red">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">Pengembalian</div>
    ...
    <?php if($this->session->userdata('akses')=='Administrator'){ ?>
        <center><h2> Anda Login Sebagai <?php echo  $this->session->userdata('akses'); ?> </h2></center>
    <?php } if($this->session->userdata('akses')=='Anggota'){ ?>
        <center><h2> Anda Login Sebagai <?php echo  $this->session->userdata('akses');
    };?> </h2></center>
<!-- jQuery -->
